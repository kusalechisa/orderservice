...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="home.php" class="brand-link">
        <img src="./src/images/AdminLTELogo.png" class="brand-image img-circle elevation-3"
            style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block">Elias Asefa</a>
            </div>
        </div>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview <?= in_array($current_page, ['index.php']) ? 'menu-open' : ''; ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="home.php" class="nav-link <?= ($current_page === 'index.php') ? 'active' : ''; ?>">
                ...
                <li class="nav-item has-treeview <?= in_array($current_page, ['logout.php']) ? 'menu-open' : ''; ?>">
                    <a class="nav-link <?= in_array($current_page, ['logout.php']) ? 'active' : ''; ?>">
